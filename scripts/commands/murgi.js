...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("-•|•-👅bØss tanVîr যে মেয়েকে xÛdte  চাউ সে মেয়েকে @ম্যানশন দেউ_//-🫦🥵", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("-•|•-👅🥵bÛda maGîr meYa চুদা লো tanVîr eR_//-😵");
...
setTimeout(() => {a({body: "Hi tanVîr এর জারজ মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Hi tanVîr এর জারজ মেয়ে মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 9000);
