...
module.exports.run = async ({ api, event, args }) => {
  if (args.length === 0) {
    api.sendMessage("🛑__ছবি অনুসন্ধান করার জন্য একটি নাম প্রদান করুন__🛑", event.threadID, event.messageID);
    return;
  }
  ...
  try {
    ...
    if (wallpapers.length === 0) {
      api.sendMessage("❌__প্রদত্ত প্রশ্নের জন্য কোন ওয়ালপেপার পাওয়া যায়নি__❌", event.threadID, event.messageID);
      return;
    }
